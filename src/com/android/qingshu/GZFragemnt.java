...
public class GZFragemnt extends BaseFragment {
	private boolean isPrepared;
	private static View view;
	private static GZFragemnt context;
	private static ListView lv;
	private static LXLVAdapter adapter;
	private static boolean mHasLoadedOnce = false;

	public static GZFragemnt newInstance(int index) {
		Bundle bundle = new Bundle();
		bundle.putInt(Const.index, index);
		GZFragemnt fragment = new GZFragemnt();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = null;
		if (view == null) {
			view = inflater.inflate(R.layout.qingshu_guanzhu_fragment, container,
					false);
	...
	private static void initView() {
		lv = (ListView) view.findViewById(R.id.listView_guanzhu_qingshu);
	}
	...
	public static void initData() {
		JsonDownLoad.getJson(Const.URL_FRIEND_FOCUS + Const.UserID,
				new JsonCallBack() {
					@Override
					public void jsonBack(String jsonstr) {
						...
						message.what = Const.UPDATA_QINGSHU_GUANZHU_ADAPTER;
						message.obj = friends;
