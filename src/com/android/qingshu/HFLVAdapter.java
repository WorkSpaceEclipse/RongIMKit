...
public class HFLVAdapter extends BaseAdapter {
	...
	public HFLVAdapter(Context context, ArrayList<Friend> qsList, ListView lv) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(
					R.layout.qingshu_huifu_adapter_fragment, null);
			holder.ivIcon = (ImageView) convertView
					.findViewById(R.id.iv_hflvadapter_icon);
			holder.tvNickName = (TextView) convertView
					.findViewById(R.id.tv_hflvadapter_nickname);
			holder.tvProvince = (TextView) convertView
					.findViewById(R.id.tv_hflvadapter_province);
			holder.tvCity = (TextView) convertView
					.findViewById(R.id.tv_hflvadapter_city);
			holder.tvTime = (TextView) convertView
					.findViewById(R.id.tv_hflvadapter_time);
			holder.tvMsgNum = (TextView) convertView
					.findViewById(R.id.tv_hflvadapter_smsnum);
			holder.tvInfo = (TextView) convertView
					.findViewById(R.id.tv_hflvadapter_info);
