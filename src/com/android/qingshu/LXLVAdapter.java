...
public class LXLVAdapter extends BaseAdapter {
	...
	public LXLVAdapter(Context context, ArrayList<Friend> qsList, ListView lv) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(
					R.layout.qingshu_lx_adapter_fragment, null);
			holder.ivIcon = (ImageView) convertView
					.findViewById(R.id.iv_lxlvadapter_icon);
			holder.tvNickName = (TextView) convertView
					.findViewById(R.id.tv_lxlvadapter_nickname);
			holder.tvProvince = (TextView) convertView
					.findViewById(R.id.tv_lxlvadapter_province);
			holder.tvCity = (TextView) convertView
					.findViewById(R.id.tv_lxlvadapter_city);
			holder.tvTime = (TextView) convertView
					.findViewById(R.id.tv_lxlvadapter_time);
			holder.tvMsgNum = (TextView) convertView
					.findViewById(R.id.tv_lxlvadapter_smsnum);
			holder.tvInfo = (TextView) convertView
					.findViewById(R.id.tv_lxlvadapter_info);
