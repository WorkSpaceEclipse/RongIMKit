...
public class LXFragemnt extends BaseFragment {
	private boolean isPrepared;
	private static View view;
	private static LXFragemnt context;
	private static ListView lv;
	private static LXLVAdapter adapter;
	private static boolean mHasLoadedOnce = false;

	public static LXFragemnt newInstance(int index) {
		Bundle bundle = new Bundle();
		bundle.putInt(Const.index, index);
		LXFragemnt fragment = new LXFragemnt();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = null;
		if (view == null) {
			view = inflater.inflate(R.layout.qingshu_lx_fragment, container,
					false);
	...
	public static void initData() {
		JsonDownLoad.getJson(Const.URL_FRIEND_NEW + Const.UserID,
				new JsonCallBack() {
					@Override
					public void jsonBack(String jsonstr) {
						...
						message.what = Const.UPDATA_QINGSHU_LIANXI_ADAPTER;
						message.obj = friends;
